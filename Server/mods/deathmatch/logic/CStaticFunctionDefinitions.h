...
public:
    ...
    static bool           IsElementServersideOnly(CElement* pElement, bool& bOutEnabled);
    ...
    static bool SetElementServersideOnly(CElement* pElement, bool bEnable);
    ...
    static CVehicle* CreateVehicle(CResource* pResource, unsigned short usModel, const CVector& vecPosition, const CVector& vecRotation, const char* szRegPlate,
                                   unsigned char ucVariant, unsigned char ucVariant2, bool bSynced, bool bServersideOnly);
